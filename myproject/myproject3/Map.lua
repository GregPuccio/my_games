...
function Map:buildLevel()
    ...
    while y <= self.mapHeight do
        ...
        for x = self.mapWidth - 16, self.mapWidth - 10 do
        ...
        if y < self.mapHeight - 4 and y > 4 then
            ...
            if math.random(2) == 1 then
                local platformLoc2 = math.random(self.mapWidth)
            ...
            if math.random(2) == 1 then
            local platformLoc3 = math.random(self.mapWidth)
                self:setTile(platformLoc3, y, TILE_BRICK)
                self:setTile(platformLoc3 + 1, y, TILE_BRICK)
                    if math.random(5) == 1 then
                        self:setTile(platformLoc3 + 2, y, TILE_BRICK)
                    end
            end
        end
        y = y + 1
