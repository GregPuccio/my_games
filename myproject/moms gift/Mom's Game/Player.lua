...
function Player:init(map)
    ...
    self.music = love.audio.newSource('sounds/jump.wav', 'static')
    self.music:setVolume(0.50)
    ...
    self.y = map.mapHeightPixels - self.height * 2
...
function Player:getX(dt)
    return self.x
end

function Player:getY(dt)
    return self.y
end
...
function Player:update(dt)
    ...
    if self.y < 16 and gameState == 'climb' then
